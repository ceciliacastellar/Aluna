...
<div class="contenido">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i><a href="/alumno">Listado de alumnos</a></li>
    ...
    <!-- --------------------------------------- PESTAÑAS------------------------------------------------- -->
    <div class="row">
      <form method="POST" action="{{route('alumno.update', $alumnos->id)}}" accept-charset="UTF-8" enctype="multipart/form-data">
