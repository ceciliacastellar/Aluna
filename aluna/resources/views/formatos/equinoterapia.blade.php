...
<div class="contenido">
   <!-- <img src="img/menu.png" alt="" class="menu-bar">-->
    ...
    <nav>
       ...
       <ol class="breadcrumb">
            ...
            <li><i class="fa fa-th-list"></i>Formato de equinoterapia</li>
   ...
   <div class="row">
     <form method="POST" action="{{ route('formatos.storeequi', $alumnos->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
