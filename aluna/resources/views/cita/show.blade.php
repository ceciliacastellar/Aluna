            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li><i class="fa fa-user-md"></i> <a >Area de salud de: {{ $citas->alumno->nombres }}{{ $citas->alumno->apellidos }}</a></li>
                      <li><i class="fa fa-th-list"></i><a href="{{ route('cita.index', $citas)}}">Listado de citas</a></li>
